    ...
    <>
      <div className='bg-white dark:bg-[#151D3B] h-full w-full'>
        <div className='flex justify-center'>
          <svg className='absolute left-0 top-[79px] h-[250px] md:h-[180px] sm:h-[90px]' viewBox="0 0 96 390" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='flex flex-col justify-center items-center w-[70%] md:items-start'>
            <h1 className='font-Metamorphous font-[400] text-[40px] pt-[192px] text-[#000000] dark:text-[#fff] lg:text-[38px] md:pt-[240px] md:text-[20px] sm:text-[15px] '>Hello Recruiter,</h1>
            <h1 className=' font-Metamorphous font-[400] text-[38px] items-center dark:text-[#fff] lg:text-[38px] md:text-[30px] md:min-h-[30px] md:py-[20px] sm:text-[15px] '>Welcome to my project hub</h1>
            <p className=' font-Metamorphous font-[200] text-[20px] text-gray-500 dark:text-gray-300 lg:text-[25px] lg:font-[100] md:min-h-[30px]  md:text-[17px] sm:text-[10px] '>As a frontend engineer, specialist in javascript. I have some couple of projects built with javascript libraries and typescript. Am always a ReactJs fan</p>
          </div>
        </div>
        <span className='flex justify-end'>
          <svg className='h-[250px] md:h-[180px] sm:h-[90px]'  viewBox="0 0 99 392" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='h-full w-full'>
          <h1 className=' mx-[30px] font-Metamorphous font-[400] text-[92px] text-[#000000] dark:text-[#fff] lg:text-[58px]  md:text-[45px] sm:text-[25px]  '>Recent Projects</h1>
          <div className='flex items-center  justify-between md:block md:justify-center'>
            ...
            <div className='px-[30px]'>
              <h1 className=' font-Poppins font-[400] text-[42px] text-[#000000] dark:text-white xl:text-[30px] lg:text-[28px] md:text-[30px] md:min-h-[30px] sm:text-[15px]  '>Cov19Strain Application</h1>
              ...
              <div className=' h-[120px] w-[120px] bg-[#FF6B6BE5] rounded-full mt-[40px] flex items-center justify-center font-Poppins font-[300] text-[20px] dark:text-white md:w-[90px] md:h-[90px] '>
                <p>View</p>
              </div>
            </div>
          </div>
        ...
        <div className=' h-full w-full'>
          <svg className='h-[250px] mt-[30px] md:h-[180px] sm:h-[90px] ' viewBox="0 0 96 390" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M-5.04033 203.387C8.08377 202.926 20.9885 199.885 32.9372 194.437C44.8858 188.988 55.6444 181.24 64.5985 171.634C73.5527 162.028 80.527 150.752 85.1235 138.45C89.7199 126.149 91.8484 113.062 91.3874 99.9384C90.9263 86.8143 87.8848 73.9095 82.4365 61.9608C76.9882 50.0122 69.2398 39.2537 59.6337 30.2995C50.0276 21.3454 38.7518 14.371 26.4503 9.77454C14.1488 5.1781 1.06244 3.04963 -12.0617 3.51066L-10.7977 39.4907C-2.39861 39.1956 5.97639 40.5578 13.8491 43.4994C21.7218 46.441 28.938 50.9045 35.0857 56.635C41.2334 62.3654 46.1922 69.2506 49.679 76.8975C53.1658 84.5444 55.1123 92.8031 55.4073 101.202C55.7024 109.601 54.3402 117.976 51.3986 125.849C48.457 133.722 43.9935 140.938 38.2631 147.086C32.5326 153.233 25.6474 158.192 18.0005 161.679C10.3537 165.166 2.09489 167.112 -6.30424 167.407L-5.04033 203.387Z" fill="#FF6B6B" fillOpacity="0.9"/>
              <path d="M-2.91184 389.212C9.97975 389.207 22.744 386.662 34.6521 381.723C46.5601 376.784 57.3789 369.549 66.4906 360.429C75.6022 351.309 82.8284 340.484 87.7565 328.571C92.6846 316.659 95.2181 303.892 95.2124 291.001C95.2066 278.109 92.6618 265.345 87.7231 253.437C82.7844 241.529 75.5486 230.71 66.4288 221.598C57.309 212.487 46.4838 205.261 34.5714 200.332C22.6589 195.404 9.8924 192.871 -2.9992 192.877L-2.98347 228.219C5.26686 228.216 13.4371 229.837 21.0609 232.991C28.6846 236.145 35.6124 240.769 41.4489 246.601C47.2854 252.432 51.9161 259.356 55.0768 266.976C58.2374 274.597 59.8661 282.766 59.8698 291.016C59.8734 299.267 58.252 307.437 55.0982 315.061C51.9443 322.685 47.3197 329.612 41.4884 335.449C35.6572 341.285 28.7334 345.916 21.1125 349.077C13.4916 352.237 5.32277 353.866 -2.92756 353.87L-2.91184 389.212Z" fill="#FF6B6B" fillOpacity="0.9"/>
          </svg>
          <div className='flex items-center justify-between space-x-10 md:block md:justify-center md:space-x-0'>
            <div className='px-[30px]'>
              <h1 className='font-Poppins  font-[400] text-[52px] text-[#000000] dark:text-white xl:text-[30px] lg:text-[28px] md:text-[30px] md:min-h-[30px] sm:text-[15px]  '>DogHub Application</h1>
        ...
        <div className='h-full w-full pb-[30px]'>
          <div className='flex items-center justify-between md:block md:justify-center'>
            ...
            <div className='px-[30px]'>
              <h1 className=' font-Poppins font-[400] text-[42px] text-[#000000] dark:text-white lg:text-[28px] md:text-[30px] md:min-h-[30px] sm:text-[15px]  '>Wordlen Application</h1>
              <p className=' font-Poppins font-[400]  text-[#000000] text-[12px] dark:text-white md:pt-[90px] md:text-[14px] '>Covid-19 tracker is an application that help you keep tracks of covid-19 situation <br /> locality and even beyond your locality. This application will teach/guide you to <br /> prevent yourself from been infected.</p>
              <div className='flex space-x-5 items-center mt-[19px] sm:space-x-2'>
