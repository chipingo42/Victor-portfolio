      ...
      <div className='h-full w-full bg-[#ececec] dark:bg-[#151D3B] dark:w-full flex lg:block '>
        ...
        <div className=' max-w-[1000px] mx-auto lg:max-w-[750px] md:max-w-[600px] sm:max-w-[300px] '>
          ...
          <span className='absolute right-0'>
              <svg className='h-[250px] mt-6 md:h-[180px] sm:h-[129px]'  viewBox="0 0 99 392" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='py-[70px] mt-[120px] '>
            <h1 className=' font-Metamorphous font-[400] text-[70px] text-black dark:text-white md:text-[40px] sm:text-[28px] '>About Me</h1>
