...
const About = () => {
  return (
    <>
      <div className='h-full w-full pb-10 bg-[#ececec] dark:bg-[#151D3B] dark:w-full flex lg:block'>
                ...
                <div>
                  ...
                  <div className='flex flex-col space-y-2 mt-[15px]'>
                    ...
                    <div className='flex items-center space-x-2'>
                      ...
                      <p className=' font-Poppins font-[300] text-[18px] text-black dark:text-white '>Typescript</p>
                    </div>
                    <div className='flex items-center space-x-2'>
                      <span className='bg-[#FF6B6BE5] h-[20px] w-[20px] rounded-full flex items-center justify-center '>
                        <BsDot className=' text-[27px] text-white dark:text-[#000000] ' />
                ...
                <div>
                  ...
                  <div className='flex flex-col space-y-2 mt-[15px]'>
                    ...
                    <div className='flex items-center space-x-2  '>
                      ...
                      <p className=' font-Poppins font-[300] text-[18px] text-black dark:text-white '>cloudflare</p>
                    </div>
                  </div>
                </div>
                <div>
