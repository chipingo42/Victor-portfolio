  ...
  return (
    <nav className='fixed top-0 z-10 bg-white h-[72px] w-full shadow-xl dark:bg-[#151D3B] '>
      <div className='max-w-[1200px] mx-auto'>
        <div className='flex items-center md:mx-[10px] md:mt-[16px]'>
          <Link to='/' className='flex-1'>
            <svg className='mt-[10px] fill-black dark:fill-white h-[70px] md:h-[40px] '  viewBox="0 0 60 91" fill="none" xmlns="http://www.w3.org/2000/svg">
